...
export var SCHEDULE_CATEGORY = ["milestone", "task"];
...
export function generateTime(schedule, renderStart, renderEnd) {
...
export function generateRandomSchedule(calendar, renderStart, renderEnd) {
